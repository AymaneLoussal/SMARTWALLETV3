...
<main class="container">
    ...
    <div class="page-header" style="margin-bottom: 2rem;">
        ...
        <p class="text-muted">Create a new expense entry</p>
    </div>
    ...
    <div class="card" style="max-width: 600px;">
        <form method="POST" action="<?php echo BASE_URL; ?>/expense/store" novalidate>
            <!-- CSRF Token -->
            ...
            <div class="form-group">
                ...
                <textarea id="description"
                          ...
                          class="form-control"
                          rows="4"
                          placeholder="Add notes about this expense..."><?php echo htmlspecialchars($formData['description'] ?? '', ENT_QUOTES, 'UTF-8'); ?></textarea>
            </div>
